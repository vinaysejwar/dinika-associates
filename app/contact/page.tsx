            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4 flex items-center gap-4">
                <button 
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-primary px-8 py-4 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90 disabled:opacity-70 disabled:cursor-not-allowed min-w-[180px]"
                >
                  {status === "submitting" ? (
                    "Sending..."
                  ) : status === "success" ? (
